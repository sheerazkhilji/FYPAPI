...
namespace API.Controllers
{
    ...
    public class VendorController : ControllerBase
    {
        ...
        [HttpPost("ApproveVendor/{id}")]
        public Response ApproveVendor(int id)
        {
            UserManagement user = null;
            Response response = new Response();
            try
            {
                ...
                var res = _service.ApproveVendor(id);
                response = CustomStatusResponse.GetResponse(200);
                if (res > 0)
                {
                    response.Data = res;
        ...
        [HttpPost("ActiveInActiveVendor/{id}")]
        public Response ActiveInActiveVendor(int id)
        {
            UserManagement user = null;
            Response response = new Response();
            try
            {
                ...
                var res = _service.ActiveInActiveVendor(id);
                response = CustomStatusResponse.GetResponse(200);
                if (res > 0)
                {
                    response.Data = res;
